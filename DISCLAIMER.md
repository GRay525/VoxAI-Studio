...
VoxAI Studio is a desktop application for AI-powered voice synthesis based on the IndexTTS project. By downloading, installing, or using this software, you agree to be bound by the terms set forth below. If you do not agree, do not use this software.
...
This project is based on IndexTTS by the index-tts team (https://github.com/index-tts/index-tts). All rights to the underlying IndexTTS technology belong to its original developers.
...
- GitHub Issues: [YOUR-GITHUB-URL] (tag: "abuse-report")
- Email: [YOUR-EMAIL] (subject: "VoxAI Studio Misuse Report")
...
**Previous Version:** 1.0 (January 18, 2026)
